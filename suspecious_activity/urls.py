...
urlpatterns = [
    ...
    path('viewcriminalistsrch', views.viewcriminalistsrch, name="viewcriminalistsrch"),
    path('feedbacksrch', views.feedbacksrch, name="feedbacksrch"),
    path('managepolicesrch', views.managepolicesrch, name="managepolicesrch"),
    path('managecriminallistsrch', views.managecriminallistsrch, name="managecriminallistsrch"),
    path('viewcomplaintsrch', views.viewcomplaintsrch, name="viewcomplaintsrch"),
    path('taskstatussrch', views.taskstatussrch, name="taskstatussrch"),
    path('logout', views.logout, name="logout"),
    path('viewcrimerecordsrch', views.viewcrimerecordsrch, name="viewcrimerecordsrch"),
    # $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ webservice$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
